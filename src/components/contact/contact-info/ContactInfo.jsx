...
const ContactInfo = () => {
  return (
    <>
      <div className="lg:w-1/2 lg:mx-8 lg:mt-4">
        ...
        <div className="mt-6 space-y-8 md:mt-8">
          <p className="flex items-start">
            ...
            <span
              className="mx-2 text-gray-400 truncate w-72"
              title="Pilani, Rajasthan"
            >
              Pilani, Rajasthan
            </span>
          </p>
          <p className="flex items-start">
            ...
            <span className="mx-2 text-gray-400 truncate w-72">
              <a
                href="mailto:shubhambhoj3@example.com"
                title="shubhambhoj3@gmail.com"
              >
